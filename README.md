...
<h1 align="center">Timofey® 03.03.2023 <img src="https://img.shields.io/badge/version-v0.1.14-blue" alt="version"></h1> 
...
<ul>
 ...
 <li>Главная программа (main.py);
  <ul>
    <li>Берёт изображение, созданное конвертером, для обработки, в результате выводит ответ — число;</li>
  </ul>
 </li>
